    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            Action::make('first')
                ...
                ->url(function () {
                    $firstRecord = Tonnage::orderBy('code', 'asc')->first();
            ...
            Action::make('prev')
                ...
                ->url(function () {
                    $prevRecord = Tonnage::where('code', '<', $this->record->code)->orderBy('code', 'desc')->first();
            ...
            Action::make('next')
                ...
                ->iconPosition('after')
                ->url(function () {
                    $nextRecord = Tonnage::where('code', '>', $this->record->code)->orderBy('code', 'asc')->first();
            ...
            Action::make('last')
                ...
                ->iconPosition('after')
                ->url(function () {
                    $lastRecord = Tonnage::orderBy('code', 'desc')->first();
