...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('materials', function (Blueprint $table) {
            ...
            $table->boolean('enable_max_stock')->default(false);
            $table->decimal('max_stock')->default(0);
            $table->decimal('reorder_point')->default(0);
            $table->text('description')->nullable();
            $table->string('mold_no', 50)->nullable();
            ...
            $table->string('drawing_no', 150)->nullable();
            $table->string('process_routes', 150)->nullable();
            $table->string('drawing_level', 10)->nullable();
            ...
            $table->enum('regrind_method', ['inline', 'offline', 'no_regrind'])->nullable();
            $table->enum('carton_category', ['A', 'B', 'C', 'D', 'E'])->nullable();
            ...
            $table->foreignId('dimension_unit_id')->nullable()->constrained('units')->onDelete('set null');
